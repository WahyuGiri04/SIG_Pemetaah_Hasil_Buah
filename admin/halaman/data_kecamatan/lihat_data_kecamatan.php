                    ...
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2"><i class="fa fa-edit" ></i> Edit Data Kacamatan</a></li>
                            </ul>
                            <div class="tab-content">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal<?php echo $id_hasil_buah ?>">
                                                                                    <i class="fa fa-edit"></i>
                                                                                    Edit data
                                                                                </button>
                                                                                <div class="modal inmodal" id="myModal<?php echo $id_hasil_buah ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                                                                    <div class="modal-dialog modal-lg">
                                                                                        <div class="modal-content animated fadeIn">
                                                                                            <div class="modal-header">
                                                                                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                                                                <h4 class="modal-title"><?php echo $data_hasil_buah['nama_buah'] ?></h4>
                                                                                            </div>
                                                                                            <div class="modal-body">
                                                                                                <div class="row">
                                                                                                    <div class="col-lg-12">
                                                                                                        <div class="ibox ">
                                                                                                            <div class="ibox-title">
                                                                                                                <h5>Form Edit data hasil buah <small>Kab. Banyumas</small></h5>
                                                                                                                <div class="ibox-tools">
                                                                                                                    <a class="collapse-link">
                                                                                                                        <i class="fa fa-chevron-up"></i>
                                                                                                                    </a>
                                                                                                            ...
                                                                                                            <div class="ibox-content">
                                                                                                                <form action ="../../aksi/aksi_edit_hasil_buah.php" method="post" enctype="multipart/form-data">
                                                                                                                    <div class="hr-line-dashed"></div>
                                                                                                                    <div class="form-group  row"><label class="col-sm-2 col-form-label">Jumlah (ton)</label>
                                                                                                                        <div class="col-sm-10"><input type="text" name="jumlah" value = "<?php echo $data_hasil_buah['jumlah'] ?>" class="form-control"></div>
                                                                                                                        <div class="col-sm-10"><input type="text" hidden name="id_kecamatan" value ="<?php echo $data_kecamatan['id_kecamatan'] ?>" class="form-control"></div>
                                                                                                                        <div class="col-sm-10"><input type="text" hidden name="id_hasil_buah" value ="<?php echo $id_hasil_buah ?>" class="form-control"></div>
                                                                                                                    </div>
                                                                                                                    <div class="hr-line-dashed"></div>
                                                                                                                    <div class="form-group row">
                                                                                                                        <div class="col-sm-4 col-sm-offset-2">
                                                                                                                            <button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-save"></i> Simpan Perubahan</button>
                                                                                                                            <button class="btn btn-danger btn-sm" type="submit"><i class="fa fa-close"></i> Kembali</button>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </form>
                                                                                                            </div>
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                ...
                                                                                                <button type="button" onclick="return confirm('Apakah anda yakin ?');" class="btn btn-primary">Save changes</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <a href="../../aksi/aksi_hapus_hasil_buah.php?id_hasil_buah=<?php echo $id_hasil_buah ?>&id_kecamatan=<?php echo $id_kecamatan ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ?');"><i class="fa fa-trash"> </i> Hapus Data</a>
                                                                            </td>
                                                                        </tr>
                                                                    <?php
                                                                    }
                                ...
                                <div role="tabpanel" id="tab-2" class="tab-pane">
                                    <div class="panel-body">
                                        <strong>Form Edit Data Kecamatan <?php echo $data_kecamatan['nama_kecamatan'] ?></strong>
                                        <br><br>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="ibox ">
                                                    <div class="ibox-title">
                                                        <h5>Form Edit Deskripsi</h5>
                                                        <div class="ibox-tools">
                                                            <a class="collapse-link">
                                                                <i class="fa fa-chevron-down"></i>
                                                            </a>
                                                    ...
                                                    <div class="ibox-content no-padding collapse">
                                                        <br><br>
                                                        <form action ="../../aksi/aksi_edit_deskripsi.php" method="post" enctype="multipart/form-data">
                                                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Masukkan deskripsi kecamatan</label>
                                                                <div class="col-sm-10"><textarea name ="deskripsi_kecamatan" class="form-control" placeholder="Masukkan deskripsi kecamatan <?php echo $data_kecamatan['nama_kecamatan'] ?>"><?php echo $data_kecamatan['deskripsi']; ?></textarea></div>
                                                                <div class="col-sm-10"><input type="text" hidden name="id_kecamatan" value ="<?php echo $data_kecamatan['id_kecamatan'] ?>" class="form-control"></div>
                                                            </div>
                                                            <div class="hr-line-dashed"></div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-4 col-sm-offset-2">
                                                                    <button class="btn btn-danger" type="submit"><i class="fa fa-close"></i> Kembali</button>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="ibox ">
                                                    <div class="ibox-title">
                                                        <h5>Form tambah data hasil buah <small>Kab. Banyumas</small></h5>
                                                        <div class="ibox-tools">
                                                            <a class="collapse-link">
                                                                <i class="fa fa-chevron-up"></i>
                                                            </a>
                                                    ...
                                                    <div class="ibox-content">
                                                        <form action ="../../aksi/aksi_tambah_hasil_buah.php" method="post" enctype="multipart/form-data">
