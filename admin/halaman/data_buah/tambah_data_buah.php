                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Input Data Buah-buahan</strong>
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox ">
                                <div class="ibox-title">
                                    <h5>Form Input Data Buah-buahan <small>Kab. Bnayumas</small></h5>
                                ...
                                <div class="ibox-content">
                                    <form action ="../../aksi/aksi_tambah_data_buah.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Nama Buah-buahan </label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-9"><input type="text" name="nama_buah" class="form-control"></div>
                                        </div>
                                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Gambar </label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-9"><input type="file" name="gambar" class="form-control"></div>
                                        </div>
                                        <div class="form-group  row"><label class="col-sm-2 col-form-label"> Pilih Warna </label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-9"><input type="color" id="user-color" name="kode_warna" value="#e9a2a2" class=""></div>
                                        </div>
                                        ...
                                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Kode Warna Monokromatik</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-9 color-scheme1"></div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group row">
                                            <div class="col-sm-4 col-sm-offset-2">
                                                <a class="btn btn-white" type="submit"><i class="fa fa-backward" ></i> Kembali</a>
                                                <button class="btn btn-primary" type="submit">Tambah data <i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var cekWarna = document.querySelector('#user-color'),
                ...
                colorScheme1 = document.querySelector('.color-scheme1'),
            ...
            cekWarna.addEventListener('change', function() {
                ...
                w.innerHTML ='<input type="text" name="warna_monokromatik" class="form-control" value = "'+ colorList +'">';
                colorScheme1.appendChild(w);
            });
        });        
    </script>
</body>
